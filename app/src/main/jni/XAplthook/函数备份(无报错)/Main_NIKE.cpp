...
if (ImGui::Button("主页区域",ImVec2(115 -20, 40)))//260
{
菜单 = true;
菜单1 = false;
菜单2 = false;
...
if (ImGui::Button("绘制区域",ImVec2(115 -20, 40)))//260
{
菜单 = false;
菜单1 = true;
菜单2 = false;
...
ImGui::ItemSize(ImVec2(0, 2));*/
if (ImGui::Button("自瞄区域",ImVec2(115 -20, 40)))//260
{
菜单 = false;
菜单1 = false;
菜单2 = true;
...
ImGui::ItemSize(ImVec2(0, 2));*/
if (ImGui::Button("功能区域",ImVec2(115 - 20, 40)))//320
{
菜单 = false;
菜单1 = false;
菜单2 = false;
...
if (ImGui::Button("美化区域",ImVec2(115 - 20, 40)))//320
{
菜单 = false;
菜单1 = false;
菜单2 = false;
...
if (ImGui::Button("人物广角『Close』",{-1, 70})){
广角 = true;
}
...
if (ImGui::BeginChild("子菜单0", ImVec2(0, 0), true, ImGuiWindowFlags_None));
{
if (ImGui::Button("载入自瞄",ImVec2(150, 35))){
自动瞄准 = true;

}
ImGui::Spacing();
if (ImGui::Button("函数追踪",ImVec2(150, 35))){
函数追踪 = true;
...
0x7513B0,0x78,0x60,0x30,0x358,0x118

3.3.0 全球服 64位 衣服美化链条*/
ImGui::SameLine(); 
