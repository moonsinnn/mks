...
#define GEngine_Offset 0xcee7650
#define Process_Event_Offset 0x778f3a4
...
bool 文字 = false;
bool 登录界面 = false;
static float 急救大小 = 100;
static float 急救距离 = 0.00f;
bool 追踪1 = false;
bool 自瞄 = false;
bool 急救;
bool 准星;
static bool 枪械辅助 = true;
...
static float 动作判断X轴 = 8.08f;
static float 动作判断Y轴 = 39.73f;
static float 手持图片X轴 = 1.98f;
static float 手持图片Y轴 = 38.57f;
bool 美化 = false;
int 套装 = 0;
int 眼罩 = 0;
int 播报 = 0;
...
//半杀67
if (全局离线){
//[1].地址:9ACDA8A0    数值:-1619335891
写入D类(gcloud + 0x423620, -1664208);
//[2].地址:9AD03D90    数值:-1619335891
//写入D类(gcloud + 0x334D90, 100000001);
}else{
...
写入D类(anogs+0xE04A8,256);//书生
写入D类(anogs+0xE0518,256);//书生
写入D类(anogs+0xE0888,256);//书生
写入D类(anogs+0xE0890,256);//书生
写入D类(anogs+0xE0894,256);//书生
写入D类(anogs+0xE09E8,256);//书生
写入D类(anogs+0xE1D54,256);//书生
写入D类(anort+0x12BA60,256);//书生
写入D类(anort+0x12BA64,256);//书生
写入D类(anort+0x12BA68,256);//书生
写入D类(anort+0x12BA6C,256);//书生
写入D类(anort+0x12BA70,256);//书生
写入D类(anort+0x12BA74,256);//书生
写入D类(anort+0x12BA78,256);//书生
写入D类(anort+0x12BA7C,256);//书生
写入D类(anort+0x12BA80,256);//书生
写入D类(anort+0x12BA84,256);//书生
写入D类(anort+0x12BA88,256);//书生
写入D类(anort+0x12BA90,256);//书生

}


if (大厅) {
写入D类(UE4+0x380A9E0,196864);//书生
写入D类(UE4+0x380AE80,196864);//书生
写入D类(UE4+0x380AEA4,196864);//书生
写入D类(UE4+0x380AEC0,196864);//书生
写入D类(UE4+0x380AEC8,196864);//书生
写入D类(UE4+0x380AED4,196864);//书生
写入D类(UE4+0x380AED8,196864);//书生
写入D类(UE4+0x380AEDC,196864);//书生
写入D类(UE4+0x380AEE4,196864);//书生
写入D类(UE4+0x380AF14,196864);//书生
写入D类(UE4+0x380AF48,196864);//书生
写入D类(UE4+0x380AF50,196864);//书生
写入D类(UE4+0x380AF98,196864);//书生
写入D类(UE4+0x380AFD4,196864);//书生
写入D类(UE4+0x380B8B0,196864);//书生
写入D类(UE4+0x380B8B4,196864);//书生
写入D类(UE4+0x384FB9C,196864);//书生
写入D类(UE4+0x388E2A4,196864);//书生
写入D类(UE4+0x38B2940,196864);//书生
写入D类(UE4+0x38E8E08,196864);//书生
写入D类(UE4+0x3930400,196864);//书生
写入D类(UE4+0x3964BF4,196864);//书生
写入D类(UE4+0x39766C0,196864);//书生
写入D类(UE4+0x399A154,196864);//书生
写入D类(UE4+0x39A64A4,196864);//书生
写入D类(UE4+0x39D8190,196864);//书生
写入D类(UE4+0x3A1501C,196864);//书生
写入D类(UE4+0x3A165BC,196864);//书生
写入D类(UE4+0x3A2D5A4,196864);//书生
写入D类(UE4+0x3A434E8,196864);//书生

写入D类(anogs+0x54C260,0);//书生
写入D类(anogs+0x54C278,0);//书生
写入D类(anogs+0x54C27C,0);//书生
写入D类(anogs+0x54C294,0);//书生
写入D类(anogs+0x54C298,0);//书生
写入D类(anogs+0x54C350,0);//书生
写入D类(anogs+0x54C480,0);//书生
写入D类(anogs+0x54C5B8,0);//书生
写入D类(anogs+0x54C6F8,0);//书生
写入D类(anogs+0x54C950,0);//书生
写入D类(anogs+0x54CA88,0);//书生
写入D类(anogs+0x54CAE8,0);//书生
写入D类(anogs+0x54CC60,0);//书生
写入D类(anogs+0x54CE94,0);//书生
写入D类(anogs+0x54D4F0,0);//书生
写入D类(anogs+0x54D570,0);//书生
写入D类(anogs+0x54D61C,0);//书生
写入D类(anogs+0x54D64C,0);//书生
写入D类(anogs+0x54D698,0);//书生
写入D类(anogs+0x54D69C,0);//书生
写入D类(anogs+0x54D764,0);//书生
写入D类(anogs+0x54D7A0,0);//书生
写入D类(anogs+0x56FAE4,0);//书生
写入D类(anogs+0x56FAFC,0);//书生
写入D类(anogs+0x56FB00,0);//书生
写入D类(anogs+0x56FB14,0);//书生
写入D类(anogs+0x56FB2C,0);//书生
写入D类(anogs+0x56FB30,0);//书生
写入D类(anogs+0x56FB44,0);//书生
写入D类(anogs+0x56FB60,0);//书生
写入D类(anogs+0x56FB74,0);//书生
写入D类(anogs+0x572C78,0);//书生
写入D类(anogs+0x58A4DC,0);//书生


写入D类(UE4+0x25c115c,256);
写入D类(UE4+0x26a7afc,256);
写入D类(UE4+0x278de64,256);
写入D类(UE4+0x279edd4,256);
写入D类(UE4+0x27dc618,256);
写入D类(UE4+0x2932bcc,256);
写入D类(UE4+0x29821d4,256);
写入D类(UE4+0x29a546c,256);
写入D类(UE4+0x2db5c50,256);
写入D类(UE4+0x2e011bc,256);
写入D类(UE4+0x2e582ac,256);
写入D类(UE4+0x2ecbdc0,256);
写入D类(UE4+0x317e498,256);
写入D类(UE4+0x31bc880,256);
写入D类(UE4+0x323be28,256);
写入D类(UE4+0x24670e0,256);
写入D类(UE4+0x247243c,256);
写入D类(UE4+0x2656370,256);
写入D类(UE4+0x2872b94,256);
写入D类(UE4+0x29b2404,256);
写入D类(UE4+0x2cfe3cc,256);
写入D类(UE4+0x2f163ac,256);
写入D类(UE4+0x24a33e4,256);
写入D类(UE4+0x24e59b8,256);
写入D类(UE4+0x2586d24,256);
写入D类(UE4+0x2d436bc,256);
写入D类(UE4+0x2d61610,256);
写入D类(UE4+0x2e0c0f8,256);
写入D类(UE4+0x2fc7484,256);
写入D类(UE4+0X246DC28,17024);
MemoryPatch::createWithHex("libUE4.so", 0x231E37C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231E078, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231DFA8, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231DC68, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231B81C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231B414, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231B170, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231B108, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231AD60, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231AD58, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231AC90, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231ABC0, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231AB84, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231A70C, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231A6E0, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2319D54, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2319C48, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231993C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231938C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x23192F8, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2319184, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2319150, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2318D5C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2318A94, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2318728, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231861C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231603C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231475C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231413C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x231334C, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2311938, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2307A2C, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F7CA8, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F7C0C, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F7BD8, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F7694, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F74FC, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F3AC0, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F3920, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22F0AF8, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EF918, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EF744, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EF6E4, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EEFA0, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EDEFC, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EDBF8, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22ED424, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22ED388, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EBED0, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EBE34, "80 42 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EBB5C, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EA348, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EA2AC, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x22EA008, "00 01 00 00").Modify();
MemoryPatch::createWithHex("libUE4.so", 0x2110008, "00 01 00 00").Modify();

} 
if (防封) {//h 01 06 76 70

PATCH_LIB("libUE4.so","0xF614C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6150","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6154","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6158","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6210","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF62D4","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF63D0","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF647C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF648C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6658","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6670","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6858","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF69B4","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF69E8","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6A00","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6A34","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6AFC","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6B00","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF6C20","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF76F0","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF7DBC","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF7DC0","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF7DEC","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF7FCC","h 01 06 76 70");
PATCH_LIB("libUE4.so","0xF7FF8","h 01 06 76 70");

PATCH_LIB("libUE4.so","0x830FC","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83178","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83194","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x831F8","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83220","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83224","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83230","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83238","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83320","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83354","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x834CC","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83898","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83A90","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83A94","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83A98","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x83A9C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x8445C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x84B14","h 01 06 76 70");

PATCH_LIB("libUE4.so","0x555000","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x555008","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x555054","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x555058","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x555068","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x555920","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x55595C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x555B18","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x555B1C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x556158","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x55615C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x5561E4","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x55685C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x5568D0","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x556AE8","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x556B58","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x556BD0","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x556E1C","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x556E30","h 01 06 76 70");
PATCH_LIB("libUE4.so","0x556E38","h 01 06 76 70");

PATCH_LIB("libanogs.so","0x9198","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10298","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10350","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10370","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x1043c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x108a4","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x108d0","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x108dc","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10950","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10998","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x109b0","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x109d8","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10a28","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10a88","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10e94","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x10fc4","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x11438","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x114f0","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x11570","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x11800","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x3404c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34968","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x3498c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x349a4","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x349c8","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x349e8","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34ac0","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34b00","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34b4c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34b58","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34d30","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34d9c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34e40","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x34f14","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x35018","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x350e4","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x351dc","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x35208","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x35358","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x3541c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x354c8","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x354e4","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x3599c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x359c4","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x35ad8","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x35b4c","h 01 06 76 70");//书生书生
PATCH_LIB("libanogs.so","0x35bb0","h 01 06 76 70");//书生书生

//579,862,784
PATCH_LIB("libUE4.so","0x2471ac4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24745e4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x248be94","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x248fb6c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2491a90","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x249c3bc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24a84e8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24ab1f8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24aedd0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24ca8dc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24ef318","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24ef624","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24f7d58","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x24fa51c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2503154","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2503834","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x250a698","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x250a9d0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x250eccc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x251107c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2539824","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2539d50","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2539d84","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x254164c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x254237c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2548034","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x255c108","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2561940","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2564600","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2570658","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2572bfc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2590184","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2590764","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25907cc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2598b54","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25af27c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25af2e4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25c90a0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25ca9c4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25cc20c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25cd8ec","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25d5708","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25e151c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25e2470","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25e2f9c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25e80e8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25e811c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25ea858","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25ed55c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2098","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2168","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f23d8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2780","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f27e8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f281c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2850","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f28b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f28ec","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2954","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2988","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f29f0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2c2c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2c94","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2cc8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f2e00","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f37ac","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f3f74","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f3fa8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x25f825c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x260d16c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26149f8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2615170","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x261fe3c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2630150","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x263a0e0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2648d3c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26708b4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26770f8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2681dcc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6220","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6288","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a62f0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6324","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6424","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6760","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a69d0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6a38","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6aa0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6ba4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a6c0c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a7398","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a7434","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26a749c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26ad760","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26b2204","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26b3524","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26bc338","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26ce92c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26d89b4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26e4dd4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26ed954","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26f4b2c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26fe4e0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26fe548","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26fea24","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x26fea58","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2702ce4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2711c00","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2718a74","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2719a20","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x27235a8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2739fe8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2773560","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x27938b4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x27ae040","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x27c3b20","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x27d071c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2822bac","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2826d54","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2834134","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2834964","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2834cdc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x283836c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28398fc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2849318","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x286a13c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2875a60","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x288262c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2896930","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x289f3f4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28a1204","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28a5748","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28a8330","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28b96ec","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28b97bc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28c67a0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28e69c0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28e7514","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28eb32c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28ecb4c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28ed9c4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28efe2c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28f330c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28ff414","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x28ffed4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2906ab4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2910fdc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2915150","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2926fd0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2944428","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29486f8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2957fe0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x295a4a8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x295ac5c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2979064","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x297b544","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x298aa08","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29986dc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2998efc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x299e914","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29c121c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29c3398","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29c8f7c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29caa1c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29ddf1c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29e5950","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x29fb8b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a17d1c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a243d0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a2bb0c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a2bb68","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a314b0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a39b84","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a3a134","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a42094","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a48900","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a52228","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a5573c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a5f27c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a61ae0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a624b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a62f50","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a6a55c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a6ebd0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a77ad0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a81b30","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a83414","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a9ca28","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2a9d9e4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aa05ac","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aa7b94","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aa7b98","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aa7c68","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aa7d00","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aa7d9c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aaba10","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2abc050","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ac623c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ac65c8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ade8a8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2aebd44","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b02234","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b06178","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b06e78","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b11918","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b2c2dc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b2f97c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b4eb84","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b55fb4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b60510","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b696f8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b6c698","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b77120","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b79068","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b82ab0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b82eb8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b832c0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b86034","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b8b538","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b8b7fc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b8cf18","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b8f958","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b8f9b4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b98a60","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2b9df8c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ba0c78","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ba2e64","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2bb20ec","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2bdd150","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2be3520","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2be7bf4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2bf2a38","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2bf45d8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2bffe50","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2c099e4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2c83d10","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2c87e3c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2c9ca68","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2c9cfe8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2cad870","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2cadacc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2cadd28","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2cadf84","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2cae1e0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2cae43c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2cb0d7c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d126c4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d23a48","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d2f2f8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d2f56c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d2fccc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d483f8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d60424","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d7fc18","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d8fd20","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d90e50","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2d98988","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2db27b0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2dc0268","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2dc3774","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2dd1138","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2dd1ee4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ddf410","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2deee70","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2df3d64","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2df429c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2df75c8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2dfc3dc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2dfed9c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2dfedd4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e00094","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e000fc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e00404","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e0eb14","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e11814","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e31b94","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e470dc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e471ac","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e47a04","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e48050","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e6a290","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e7075c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e7092c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e71434","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e80e14","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2e936b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ea4b90","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ebddb8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ec0058","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2edfb50","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ee676c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ef3540","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2ef7dc8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2eff47c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f00c28","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f01254","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f0a840","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f36e44","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f384f4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f3c508","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f3c73c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2f90298","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2fa9970","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2fab65c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2fb58b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2fb5bc4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2fbb62c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x2fea7e0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x301b7e8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3025e08","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3025fdc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x302a820","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3030d64","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3056934","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30677a4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3072580","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30728c0","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3073f1c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3081044","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x309135c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x309e1a8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30a902c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30cd440","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30cdcc8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30d7358","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30f39d4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x30ff4cc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3113164","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x311565c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3117b54","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x311d7b4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x313975c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3139b6c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x313c244","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31473b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3152808","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31575d4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3158c98","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3158e34","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x316cad4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3173410","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3175110","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x317b28c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x317fd94","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3192afc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3192b30","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31ad13c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31b5efc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31c03c8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31d80c4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31d85a4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31db22c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x31dcbc8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x320c998","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x32128b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x3214bac","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x32174b8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x321b884","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x321ca08","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x321ceac","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x321d54c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x321d5b4","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x323d6bc","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x326432c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x328aaf8","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x328b09c","-29 A0 FC 40");//书生书生
PATCH_LIB("libUE4.so","0x328b474","-29 A0 FC 40");//书生书生

MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x24d2098,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x25c9fac,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x267a63c,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x26a7124,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2702ad4,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x277d258,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2800934,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x287589c,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2888ed4,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2a9cee8,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2a9cf50,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2b5c430,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2e1e364,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x2ea8a40,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x308c3f8,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x308c4c8,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x316aed8,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x31709e0,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x3180be0,OBFUSCATE("h 00 00 42 80")).Modify();//书生
MemoryPatch::createWithHex(OBFUSCATE("libUE4.so"),0x31f07d8,OBFUSCATE("h 00 00 42 80")).Modify();//书生


}

if (曙光芙洛拉) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x340)+0x30)+0x388)+0x118,1407103);
}
if (果冻) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x340)+0x30)+0x388)+0x118,1406970);
}

if (胖达) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x2F0)+0x280)+0x388)+0x118,1405039);
}

if (明日香) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x340)+0x30)+0x388)+0x118,1406387);

}
if (老鼠人) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x1A0)+0x0)+0x9E0)+0x11C, 1103007020);//枪械
}
if (蓝木乃伊) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x340)+0x30)+0x388)+0x118,1406894);
}
if (全枪美化) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4700)+0x18, 1101004046);//枪械m4
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x46B8)+0x18, 1101001213);//ak
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4760)+0x18, 1101008081);//m762
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x46E8)+0x18, 1101003146);//SCAR
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4748)+0x18, 1101007046);//QBZ
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4730)+0x18, 1101006033);//AUG
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x46D0)+0x18, 1101002081);//m4a16
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4718)+0x18, 1101005052);//狗砸
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4808)+0x18, 1101102017);//ace32
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x47C0)+0x18, 1101012009);//蜜罐
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4778)+0x18, 1101009001);//妹控
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4790)+0x18, 1101010019);//g36c
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x47D8)+0x18, 1101100012);//famgs
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4940)+0x18, 1102001102);//uzi
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4958)+0x18, 1102002136);//ump45
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x49D0)+0x18, 1102105002);//p90
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x49B8)+0x18, 1107001019);//mp5k
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x49A0)+0x18, 1102005041);//野牛
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4970)+0x18, 1102003080);//维克托
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4988)+0x18, 1102004048);//汤姆逊
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4C28)+0x18, 1104003026);//s12k
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4C40)+0x18, 1104004024);//dbs
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4C88)+0x18, 1104102001);//ns2000
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4C70)+0x18, 1104101001);//
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4C10)+0x18, 1104002022);//
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4BF8)+0x18, 1104001022);//s686
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4A90)+0x18, 1103006030);//mini
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4B38)+0x18, 1103100007);//
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4AF0)+0x18, 1103010006);//
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4CA0)+0x18, 1105001048);//m249
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4AD8)+0x18, 1103009022);//slr
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4A60)+0x18, 1103004037);//sks
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4AA8)+0x18, 1103007028);//
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4D78)+0x18, 1105010008);//mg3
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4CB8)+0x18, 1105002018);//db28
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4A18)+0x18, 1103001179);//98k
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4B08)+0x18, 1103011009);//
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4A30)+0x18, 1103002087);//m24
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5108)+0x18, 1103007028);//战速弩
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5078)+0x18, 1103012010);//十字弩
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4B20)+0x18, 1103012010);//AMR
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4A48)+0x18, 1103003087);//awm
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4A78)+0x18, 1103005024);//
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x4AC0)+0x18, 1103008020);//
}
if (配件美化) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5960)+0x18, 1010040462);//机瞄
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x58B8)+0x18, 1010040470);//红点
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x58E8)+0x18, 1010040468);//2倍
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5B40)+0x18, 1010040469);//全息
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x59F0)+0x18, 1010040467);//3倍
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5900)+0x18, 1010040466);//四倍
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5A08)+0x18, 1010040481);//6倍
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5708)+0x18, 1010040475);//补偿
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5738)+0x18, 1010040476);//消音
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5720)+0x18, 1010040474);//消炎
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x57E0)+0x18, 1010040477);//直角握把
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x57F8)+0x18, 1010040479);//垂直握把
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5870)+0x18, 1010040462);//激光握把
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5828)+0x18, 1010040478);//拇指握把
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5960)+0x18, 1010040483);//半截握把
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5840)+0x18, 1010040482);//轻型握把
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5D80)+0x18, 1010040462);//扩容
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5D98)+0x18, 1010040472);//快速弹夹
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5DB0)+0x18, 1010040473);//快扩
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x6F98)+0x18, 1010040473);//默认弹夹
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5EB8)+0x18, 1010040463);//不带枪托
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC516A80)+0x558)+0x30)+0x30)+0x38)+0x5E70)+0x18, 1010040463);//带枪托
}
if (齐天大圣) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x340)+0x30)+0x388)+0x118,1406327);
}
if (三鹿奶粉) {
...
if (播报美化)
   {写入D类(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x78)+0x90)+0x1618, 播报数值);}
if (自选美化) {
写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x340)+0x30)+0x388)+0x118, 衣服数值);
}
if (冰霜核心) {

写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x1A0)+0x0)+0x9E0)+0x11C, 枪械值);//枪械

}
if (龙吟妹控) {

写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x1A0)+0x0)+0x9E0)+0x11C, 1103007028);//枪械

}

if (丧尸) {

写入D类(readValueL(readValueL(readValueL(readValueL(readValueL(UE4+0xC4761E0)+0x0)+0x340)+0x30)+0x388)+0x118,1407193);
...
g_LocalController->ControlRotation =ToRotator(g_LocalController->PlayerCameraManager->CameraCache.POV.Location,                                                     targetAimPos);//修复自瞄卡屏代码
    ...
    if (剩下人数) {
  draw->AddText(NULL, ((float) density / 13.f), ImVec2(glWidth / 2.1 - 110.0f, 10.0f), IM_COL32(255,000,000,250),OBFUSCATE("  NLRVANA CHEAT          "));  
...
if (HZT == HZT::HZ2) {
    ...
    int CurHP = (int)std::max(0, std::min((int)Player->Health, (int)Player->HealthMax));
        ...
        ImU32 color_red = ImColor(255, 25, 25);
                        ImU32 color_orange = ImColor(255, 255, 0);
                        ImU32 color_green = ImColor(0, 255, 0);
        ...
        ImVec2 vEndRect = {vStart.x + boxWidth, vStart.y + boxHeight};
        draw->AddRectFilled(vStart, vEndRect, IM_COL32(255,0,0,255));
        draw->AddRectFilled(vStart, vEndFilled, IM_COL32(0,255,0,200));                     
}}
...
auto textSize = ImGui::CalcTextSize2(s.c_str(), 0, ((float) density / 45.0f));
draw->AddText(NULL, ((float) density / 25.0f), {RootPosSC.x - (textSize.x / 2), RootPosSC.y}, IM_COL32(250, 250, 210, 195), s.c_str());
}
}}
if (骨灰盒) {
...
ImGui::GetForegroundDrawList()->AddRectFilled({glWidth /2-67.5,40},{glWidth /2+60,80},ImColor(000,000,000,120),20.0f);//总背景(黑色 透明)
ImGui::GetForegroundDrawList()->AddRectFilled({glWidth /2-57,45},{glWidth /2+50,75},ImColor(000,255,000,200),20.0f);//安全背景(绿色 半透)
安全 += "安全";
auto textSize = ImGui::CalcTextSize2(安全.c_str(), 0, 35);
ImGui::GetForegroundDrawList()->AddText(NULL,35,{(glWidth / 2) - (textSize.x / 2),41},ImColor(255,255,255,255),安全.c_str());//安全文字(白色 全色)

} else if (totalEnemies + totalBots > 0) {

ImGui::GetForegroundDrawList()->AddRectFilled({glWidth /2-69,40},{glWidth /2+60,80},ImColor(000,000,000,120),20.0f);//总背景(黑色 透明)
ImGui::GetForegroundDrawList()->AddRectFilled({glWidth /2-60,45},{glWidth /2-8,75},ImColor(255,000,000,200),20.0f);//真人背景(红色 半透)
ImGui::GetForegroundDrawList()->AddRectFilled({glWidth /2-0,45},{glWidth /2+50,75},ImColor(000,255,000,200),20.0f);//人机背景(绿色 半透)
if (totalEnemies == 1) {
真人 += std::to_string((int)totalEnemies);
auto textSize1 = ImGui::CalcTextSize2(真人.c_str(), 0, 205);
ImGui::GetForegroundDrawList()->AddText(NULL,35,{(glWidth / 2) - (textSize1.x / 2),40},ImColor(255,255,255,255),真人.c_str());//真人文字(白色 全色) =1
} else if (totalEnemies < 10) {
真人 += std::to_string((int)totalEnemies);
auto textSize1 = ImGui::CalcTextSize2(真人.c_str(), 0, 165);
ImGui::GetForegroundDrawList()->AddText(NULL,35,{(glWidth / 2) - (textSize1.x / 2),40},ImColor(255,255,255,255),真人.c_str());//真人文字(白色 全色) <10
} else if (totalEnemies >= 10) {
真人 += std::to_string((int)totalEnemies);
auto textSize1 = ImGui::CalcTextSize2(真人.c_str(), 0, 105);
ImGui::GetForegroundDrawList()->AddText(NULL,35,{(glWidth / 2) - (textSize1.x / 2),40},ImColor(255,255,255,255),真人.c_str());//真人文字(白色 全色) >10
}
if (totalBots == 1) {
人机 += std::to_string((int)totalBots);
auto textSize2 = ImGui::CalcTextSize2(人机.c_str(), 0, 85);
ImGui::GetForegroundDrawList()->AddText(NULL,35,{(glWidth / 2) + (textSize2.x / 2),40},ImColor(255,255,255,255),人机.c_str());//人机文字(白色 全色)
} else if (totalBots < 10) {
人机 += std::to_string((int)totalBots);
auto textSize2 = ImGui::CalcTextSize2(人机.c_str(), 0, 65);
ImGui::GetForegroundDrawList()->AddText(NULL,35,{(glWidth / 2) + (textSize2.x / 2),40},ImColor(255,255,255,255),人机.c_str());//人机文字(白色 全色)
} else if (totalBots >= 10) {
人机 += std::to_string((int)totalBots);
auto textSize2 = ImGui::CalcTextSize2(人机.c_str(), 0, 25);
ImGui::GetForegroundDrawList()->AddText(NULL,35,{(glWidth / 2) + (textSize2.x / 2),40},ImColor(255,255,255,255),人机.c_str());//人机文字(白色 全色)
 }
}}}
...
void DelayedText(const char* text, float delaySeconds) {

    ImGui::Text("%s", text); // 显示文字

    std::this_thread::sleep_for(std::chrono::duration<float>(delaySeconds)); // 延时
...
char *appkey = OBFUSCATE("4c67316d294aed31f28cd54b25a85398");
//char *appkey = "f2bae0e5a43f819bb2cad9e0aa901680";
char *登录调用码 = OBFUSCATE("74BC5F5D5CD53D57");
char *公告调用码 = OBFUSCATE("53F09A34C7F6AB3E");
char *解绑调用码 = OBFUSCATE("EE1831E688ADFB2C");
char *心跳验证调用码 = OBFUSCATE("FCD6C73376822E8");
...
io.Fonts->AddFontFromFileTTF(FontName.c_str(),20,&font_cfg, io.Fonts->GetGlyphRangesChineseFull());
    ...
    style.ChildRounding = 5.0f; // 设置子窗口的圆角半径为5像素
    //控件圆角
	...
	ImGui::GetStyle().ScaleAllSizes(3.0f);
        ...
        io.Fonts->AddFontFromMemoryTTF((void *)BAIYI_data, BAIYI_size, 30.0f, NULL, io.Fonts->GetGlyphRangesChineseFull());
...
//ImGui::SetNextWindowSize(ImVec2(openx, 530));
if(音量键){
ImGuiIO &io = ImGui::GetIO();
...
ImGui::SetNextWindowSizeConstraints(ImVec2(900, 650), ImVec2(FLT_MAX, FLT_MAX)); 
                ...
                if (ImGui::Begin("BaiYi", &MemuSwitch, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar)) 
                {
		...
		if (ImGui::BeginChild("##左侧菜单标题", ImVec2(245, 0), true, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NavFlattened));
    		{
    		
            

            // 创建居中的按钮
            ImGui::SetCursorPosX((ImGui::GetWindowWidth() - ImGui::CalcTextSize("居中按钮").x) * 0.5f);
				auto Pos = ImGui::GetWindowPos();
			//	DrawLogo(FloatBallwd,{Pos.x + 97, Pos.y + 75}, 85);
		
        		ImGui::SetCursorPos({240, 200});
        		ImGui::Spacing();//间隔
        		ImGui::Separator();//插入分割线
        		
    			if (ImGui::Button("主页公告", ImVec2(200, 80)))
    			{
    				show_ChildMenu = 0;					
    			}
    			
    			if (ImGui::Button("高清绘制", ImVec2(200, 80)))
    			{
    				show_ChildMenu = 1;					
    			}
    			
    			if (ImGui::Button("枪械辅助", ImVec2(200, 80)))
    			{
    				show_ChildMenu = 2;				
    			} 
    			
    			if (ImGui::Button("其他功能", ImVec2(200, 80)))
    			{
    				show_ChildMenu = 3;					
    			}
    			
			/*	if (ImGui::Button("隐藏", ImVec2(200, 80)))
    			{
    				voice = false;
    		...
    		if (!show_ChildMenu) {
    			...
    			if (登录界面 == false) {
    			if (文字 == false) {
					ImGui::TextColored(ImColor(255,0,0), "(CN)嘿客白亦欢迎你   (EN)Welcome to BYMOD");
                    ImGui::Spacing();
                    ImGui::Text("<正在检测各项指标安全性>");
                    
                    ImGui::TextColored(ImColor(0,255,0), "-当前环境安全 允许访问服务器");
                    ImGui::Separator();//插入分割线
                    ImGui::Spacing();//间隔
                    } else{
                    }
                    ...
                    if (ImGui::Button("登录程序", ImVec2(-1, 50))) {
                        登录验证 = true;
                       }
                    if (ImGui::Button("购买卡密", ImVec2(-1, 45))) {}
                    ImGui::Spacing();//间隔
                    ImGui::Spacing();//间隔
                    ImGui::Spacing();//间隔
                    ImGui::TextColored(ImColor(255,0,0), "白亦直装官方公告 『By.嘿客白亦』");
                    
                    ImGui::Text("当前EGL检测值:0x768460000");

        
                    
                    ImGui::Text("如何实际版本以官方公告为主,请勿上当受骗");
                    
                    ImGui::Text("作者不会以任何方式私聊你,私聊你均为诈骗");
                    
                    ImGui::Text("赞助卡密为3/1天,发现倒卖联系售后投诉处理");
                    
                    ImGui::Text("官方频道 @BYTTKX");
                    }else {
                    if (ImGui::BeginChild("##绘图", ImVec2(0, 0), true,  ImGuiWindowFlags_NavFlattened)) 
    			    {    			
                    ImGui::Text("请输入你的卡号");
                    ImGui::InputText("", input_text, IM_ARRAYSIZE(input_text));
                    if (ImGui::Button("粘贴", ImVec2(-1, 45))) {
                    粘贴();
                    }
                    if (ImGui::Button("登录", ImVec2(-1, 45))) {
                    验证 = true;
                    ...
                    if (验证 == true) {
                    ImGui::TextColored(ImColor(255,255,255), "卡密校验成功 欢迎使用白亦直装");
                    ImGui::Text("你的卡号到期时间:永久");
                    ImGui::Text("(CN)请选择你的语言");
                    ImGui::Text("(EN)Please select your language");
                    if (ImGui::Button("中文", ImVec2(-1, 45))) {
                    语言 = true;
                    总验证 = true;
                    登录界面 = true;
                    }
                    if (ImGui::Button("English", ImVec2(-1, 45))) {
                    语言 = false;
                    ...
                    if (总验证 == true) {
                    ImGui::TextColored(ImColor(255,0,0), "(CN)很高兴认识你   (EN)Nice To Meet You");
                    ImGui::Text("当前程序版本:12.6.2 『白亦直装』");
                    ImGui::TextColored(ImColor(255,0,0), "你是心头惊鸿客，亦是眉上伤心人");
                    ImGui::Text("-耗时 %.3fms 帧率 %.1f 帧率", 1000.0f / io.Framerate, io.Framerate);
                    if (ImGui::Button("载入UE4 『EGL』", ImVec2(-1, 75))) {}
                    if (ImGui::Button("载入UE4 『Again』", ImVec2(-1, 75))) {}
                    ImGui::Text("屏幕分辨率: 2400x1080");
                    ImGui::TextColored(ImColor(0,255,0), "libUE4.so: 0x751c493000");
                    ImGui::Text("PUBG GamePaid:0x28897");
                    if (ImGui::Combo("悬浮窗颜色", &主题, "粉色经典主题风 - 永久\0初音未来主题风 - (永久)\0IOS鸡腿主题风 - (永久)\0红色暗黑主题风 - (永久)\0绿色温馨主题风 - (永久)\0")) {
                        switch (主题) 
                        {}          
                    }
    			...
    			show_ChildMenu = 0;
    				...
    				ImGui::TextColored(ImColor(255,0,0), "你是心头惊鸿客，亦是眉上伤心人");   
    				ImGui::Spacing();//间距
    				if (ImGui::Button("显示主要", ImVec2(-1, 75))) {}
    				ImGui::Spacing();//间隔
    				if (ImGui::BeginChild("##绘图", ImVec2(0, 400), true, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NavFlattened)) {
    				
    				ImGui::TextColored(ImColor(0,255,255), "『白亦直装』- 人物绘制");
                    ...
                    ImGui::SameLine();
                    ImGui::Checkbox("人物健康", &血量);
                    
                    ImGui::Checkbox("人物名称", &名字);
    				ImGui::SameLine();
                    ImGui::Checkbox("角标预警", &预警);
                    ImGui::SameLine();
                    ImGui::Checkbox("显示雷达", &雷达);
                    
                    ImGui::Checkbox("动作判断", &动作);
    				ImGui::SameLine();
                    ImGui::Checkbox("真人射线", &瞄准线);
                    ImGui::SameLine();
                    ImGui::Checkbox("显示伤害", &伤害);
                    
                    ImGui::Checkbox("狗子绘制", &狗子);
                    ImGui::SameLine();
                    ImGui::Checkbox("地铁箱子", &宝箱);
                    ImGui::SameLine();
                    ImGui::Checkbox("盒子图片", &盒子);
                    
                    
                    ImGui::Checkbox("图片手持", &手持);
                    ImGui::SameLine();
    			...
    			show_ChildMenu = 0;
    				...
    				ImGui::Toggle("自瞄总开关", &自瞄);
    				ImGui::SameLine();//同一列
    				ImGui::Toggle("追踪总开关", &追踪1);
    				
    				
    				ImGui::Checkbox("急救模式", &急救);
                    ImGui::SameLine();
                    ImGui::Checkbox("预判射线", &瞄准线);
                    ImGui::SameLine();
                    ImGui::Checkbox("准星辅助", &准星);
                    
                    
                    ImGui::Checkbox("忽略倒地", &忽略倒地);
                    ImGui::SameLine();
                    ImGui::Checkbox("忽略掩体", &掩体判断);
                    ImGui::SameLine();
                    ImGui::Checkbox("忽略人机", &忽略人机);
                    
                    ImGui::Text("急救参数设置");
                    ImGui::SliderFloat("急救大小[急救]", &急救大小, 100, 1314);
                    ImGui::SliderFloat("急救距离[急救]", &急救距离, 0.00f, 50.00f);
                    
                    ImGui::Text("Aim设置 - 方式");
                    const char* items[] = { "一直", "开火", "开镜","任何" };
                    int current_item = 0; // 当前选中的索引

                    // 创建一个下拉框
                    if (追踪 == true) {
                    if (ImGui::Combo("追踪方式", &current_item, items, IM_ARRAYSIZE(items)))       
         {
        
         }
                    
                    } else {
                    if (ImGui::Combo("自瞄方式", &current_item, items, IM_ARRAYSIZE(items)))       
         {
        
         }
                }
                    const char* 瞄准[] = { "准星优先", "距离优先" };
                    int 瞄准优先级 = 0; // 当前选中的索引

                    // 创建一个下拉框
                    if (ImGui::Combo("瞄准优先级", &瞄准优先级, 瞄准, IM_ARRAYSIZE(瞄准)))       
         {
                    ...
                    ImGui::EndChild();
                     ...
                     //ImGui::PushStyleColor(ImGuiCol_PopupBg, ImVec4(1.0f, 1.0f, 1.0f, 1.0f));//颜色
                       // ImGui::PopStyleVar();
                        ...
                        const ImVec2 minWindowSize = ImVec2(600, 650);
                       // ImGui::SetNextWindowBgAlpha(1.0);
                        ...
                        if (ImGui::CollapsingHeader("保存载入自瞄配置-仅本次安装包有效")) {}
                        ImGui::SliderFloat("持续时间", &持续时间, 0.00f, 60.00f, "%.2f", 1);    
                                                
                        ImGui::SliderFloat("自瞄速度", &自瞄速度, 0.00f, 300.00f, "%.2f", 2);      
                          
                        ImGui::SliderFloat("平滑力度", &平滑力度, 0.00f, 30.00f, "%.2f", 3);     
                                  
                        ImGui::SliderFloat("压枪强度", &压枪强度, 0.00f, 100.00f,"%.2f",2);
                        
    					ImGui::SliderFloat("子弹下坠", &子弹下坠, 0.00f, 1.50f, "%.2f", 4);        
    					     
    					ImGui::SliderFloat("Z轴下坠", &Z轴下坠, 0.00f, 2.00f, "%.2f", 5);
    					
    					ImGui::SliderFloat("预判系数比", &预判系数, 0.00f, 1200.00f, "%.2f", 5);         
    					ImGui::EndChild();
                        ImGui::End(); 						
                        }
    			...
    			show_ChildMenu = 0;
    			 ...
    			 ImGui::TextColored(ImColor(0,255,255), "内存功能 - 完全安全");
    			 
    			 ImGui::Checkbox("全图除雾", &除雾);
                    ImGui::SameLine();
                    ImGui::Checkbox("超级广角", &平板视角);
                    ImGui::SameLine();
                    ImGui::Checkbox("美化面板", &美化);
                    ImGui::Separator();//插入分割线
                    if (ImGui::Button("保存绘制", ImVec2(-1, 45))) {}
                    if (ImGui::Button("载入绘制", ImVec2(-1, 45))) {}
                    ImGui::Separator();//插入分割线
                    ImGui::Spacing();//间隔
                    ImGui::Text("绘制比例调整 | BY.白亦直装项目");
                    ImGui::SliderFloat("动作判断X轴", &动作判断X轴, 0.00f, 30.00f,"%.2f",2);
                    ImGui::SliderFloat("动作判断Y轴", &动作判断Y轴, 0.00f, 80.00f,"%.2f",2);
                    ImGui::SliderFloat("手持图片X轴", &手持图片X轴, 0.00f, 4.00f,"%.2f",2);
                    ImGui::SliderFloat("手持图片Y轴", &手持图片Y轴, 0.00f, 40.00f,"%.2f",2);*/
    			...
    			ImVec2 aimbotWindowPos = ImGui::GetWindowPos(); 
                       ...
                       // ImGui::SetNextWindowBgAlpha(1.0);
                        ...
                        if (ImGui::BeginChild("##绘图", ImVec2(0, 0), true, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NavFlattened)) {
                        ImGui::TextColored(ImColor(255,0,0), "你是心头惊鸿客，亦是眉上伤心人");   
                        if (ImGui::Combo("套装美化", &套装, "不进行操作\0")) {
                        switch (套装) 
                        {}          
                    }
                     if (ImGui::Combo("人物眼罩自选", &眼罩, "隐藏眼罩\0")) {
                        switch (眼罩) 
                        {}          
                    }
                     if (ImGui::Combo("淘汰播报自选", &播报, "取消播报\0")) {
                        switch (播报) 
                        {}          
                    }
                     if (ImGui::Combo("人物头盔美化", &头盔, "不进行操作\0")) {
                        switch (头盔) 
                        {}          
                    }
                     if (ImGui::Combo("人物背包美化", &背包, "不进行操作\0")) {
                        switch (背包) 
                        {}          
                    }
                     if (ImGui::Combo("飞行器美化", &飞行器, "不进行操作\0")) {
                        switch (飞行器) 
                        {}          
                    }
                    
                    
                        if (ImGui::CollapsingHeader("枪械美化")) {}
                        ImGui::Text("[ - ]美化皮肤装备拖地护甲  [ - ]美化枪械拖动配件");
...
int (*osub_1ECCE8)(int64_t a1, const char *a2);
int __fastcall hsub_1ECCE8(int64_t a1, const char *a2) {
if (strstr(a2, "egl")) {return 0;} return osub_1ECCE8(a1, a2);
}
/*
sub_DC040 // Lobby crash fix
sub_DE9E8 // Lobby crash fix
sub_E0254 // Lobby crash fix*/

int (*osub_18E5F4)(int64_t a1, const char *a2);
int __fastcall sub_18E5F4(int64_t a1, const char *a2) {
if (strstr(a2, "egl")) {return 0;} return osub_18E5F4(a1, a2);
}
int (*osub_1094E8)(int64_t a1, const char *a2);
int __fastcall sub_1094E8(int64_t a1, const char *a2) {
if (strstr(a2, "egl")) {return 0;} return osub_1094E8(a1, a2);
}
int (*osub_1E5774)(int64_t a1, const char *a2);
int __fastcall sub_1E5774(int64_t a1, const char *a2) {
if (strstr(a2, "egl")) {return 0;} return osub_1E5774(a1, a2);
}
int64_t (*orig_FPS90)(int64_t a1, int a2);
int64_t __fastcall hook_FPS90(int64_t a1, int a2)
{
    return 90LL;
}


void (*CryzzerInd)(__int64 a1, const char *a2);
void fastcall (__int64 a1, const char *a2) {   
      if ( strstr((const char *) a2,"egl")
    ||  strstr((const char *) a2,"libanort.so")
    ||  strstr((const char *) a2,"/data/")
    ||   strstr((const char *) a2,"signatures"))   
    {
...
//Fix crash login 64 bit 

__int64 (*oHDR)(int HDR);
__int64 hHDR(int HDR) 
{
 HDR = 5LL;
 return HDR;
}
...
int (*sub_A9DAF )(int a1, unsigned char* a2, size_t a3);
int __fastcall hsub_A9DAF(int a1, unsigned char* a2, size_t a3) {
unsigned int v7; // r0
while (true) {
if (a2 && !((a3 - 1) >> 10)) {
...
//bgmi 32bit Bypass
int __fastcall (*osub_7093618)(int a1, int a2, int a3, _BYTE *a4, void *a5, int a6);
int __fastcall hsub_7093618(int a1, int a2, int a3, _BYTE *a4, void *a5, int a6)
{
	std::this_thread::sleep_for(std::chrono::hours::max());
    return osub_7093618(a1,a2,a3,a4,a5,a6);
}
int __fastcall (*osub_709C7E4)(int a1, int a2, _DWORD *a3, _BYTE *a4);
int __fastcall hsub_709C7E4(int a1, int a2, _DWORD *a3, _BYTE *a4)
{
	std::this_thread::sleep_for(std::chrono::hours::max());
    return osub_709C7E4(a1,a2,a3,a4);
}
int __fastcall (*osub_7AC0ABC)(int a1, int a2, signed int a3, signed int a4, signed int a5, int a6, int a7);
int __fastcall hsub_7AC0ABC(int a1, int a2, signed int a3, signed int a4, signed int a5, int a6, int a7)
{
std::this_thread::sleep_for(std::chrono::hours::max());
    return osub_7AC0ABC(a1,a2,a3,a4,a5,a6,a7);
}
int __fastcall (*osub_7AC202C)(int a1, int a2, int a3);
int __fastcall hsub_7AC202C(int a1, int a2, int a3)
{std::this_thread::sleep_for(std::chrono::hours::max());
    return osub_7AC202C(a1,a2,a3);
}
_DWORD *__fastcall (*osub_742C03C)(_DWORD *result, int a2);
_DWORD *__fastcall hsub_742C03C(_DWORD *result, int a2)
{
	std::this_thread::sleep_for(std::chrono::hours::max());
    return osub_742C03C(result,a2);
}
int __fastcall (*osub_742C1D8)(int _R0);
int __fastcall hsub_742C1D8(int _R0)
{std::this_thread::sleep_for(std::chrono::hours::max());
    return osub_742C1D8(_R0);
}
_DWORD *__fastcall (*osub_7AD07E4)(int a1, int a2);
_DWORD *__fastcall hsub_7AD07E4(int a1, int a2)
{
std::this_thread::sleep_for(std::chrono::hours::max());
    return osub_7AD07E4(a1,a2);
}


__int64 __fastcall (*osub_3D03F8)(__int64 a1, __int64 a2, int a3, char a4);
__int64 __fastcall sub_3D03F8(__int64 a1, __int64 a2, int a3, char a4){
return 0LL;
}
__int64 __fastcall (*osub_12BA80)(__int64 a1, unsigned __int8 *a2, unsigned __int8 *a3);
__int64 __fastcall sub_12BA80(__int64 a1, unsigned __int8 *a2, unsigned __int8 *a3){
return 0LL;
}

__int64 __fastcall (*org_sub_934E0)(__int64 a1, unsigned __int8 *a2, unsigned __int8 *a3);
__int64 __fastcall hook_sub_934E0(__int64 a1, unsigned __int8 *a2, unsigned __int8 *a3){
return 0LL;
}
...
{
if (                                   
strstr(NameOfThread, "ace_schedule3")||
strstr(NameOfThread, "sx_rel") ||
strstr(NameOfThread, "am_cnt") ||
strstr(NameOfThread, "ce_bad") ||
strstr(NameOfThread, "ate_bi") ||
strstr(NameOfThread, "qos_filt") ||
strstr(NameOfThread, "chk_elf_header2") ||
strstr(NameOfThread, "AntiStrip_Strategy") ||
strstr(NameOfThread, "cps"))
  {
...
int  (*oget_report)(int *result, unsigned int a2);
int  hget_report(int *result, unsigned int a2){

if(a2 == 4)//getreportdata call
{
  return oget_report(result, 5u); //redirect to delete report
}
return oget_report(result,a2);//redirect to original function
}
...
__int64 __fastcall hkstrncpy_chk2(const char *a1){
    if (strstr(a1, "set_inline_hook_error") ||
    strstr(a1, "inline_hook_opcode_dismatch"))
    {
        return 0;
    }
    return hkstrncpy_chk2(a1);
}
...
HOOK_LIB("libUE4.so", "0x8C7300C",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0xA4AD18C",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0xAD929C8",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x798B02C",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x79E1E20",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x79EE81C",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x90A1890",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x9AFCEC8",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x8D2337C",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x89A11F0",IsEnable, old_IsEnable);
HOOK_LIB("libUE4.so", "0x75C4890",IsEnable, old_IsEnable);
    return NULL;
}
...
HOOK_LIB("libanogs.so", "0x28C39D", hsub_fuckkk, osub_fuckkk);
HOOK_LIB("libanogs.so", "0x74FC1", hsub_fuckkk2, osub_fuckkk2);
HOOK_LIB_NO_ORIG("libanogs.so","0xDBD60",hkstrncpy_chk2);//kill 67
HOOK_LIB_NO_ORIG("libanogs.so","0xDC510",hook_strlen);
PATCH_LIB("libanogs.so","0xE9708","h 00 00 80 D2");
PATCH_LIB("libanogs.so","0xE4238","h 00 00 80 D2");
PATCH_LIB("libanogs.so","0xE25F8","h 00 00 80 D2");   
PATCH_LIB("libanogs.so","0x3605C","00 00 80 D2 C0 03 5F D6");
PATCH_LIB("libanogs.so","0x36474","00 00 80 D2 C0 03 5F D6");
PATCH_LIB("libanogs.so","0x364DC","00 00 80 D2 C0 03 5F D6");
PATCH_LIB("libanogs.so","0x36CA4","00 00 80 D2 C0 03 5F D6");
PATCH_LIB("libanogs.so","0x36CFC","00 00 80 D2 C0 03 5F D6");
...
写入D类(anogs+0x116164,0);//书生
写入D类(anogs+0x116254,0);//书生
写入D类(anogs+0x116280,0);//书生
写入D类(anogs+0x116650,0);//书生
写入D类(anogs+0x11673C,0);//书生
写入D类(anogs+0x1171C8,0);//书生
写入D类(anogs+0x1173B4,0);//书生
写入D类(anogs+0x1174C4,0);//书生
写入D类(anogs+0x117564,0);//书生
写入D类(anogs+0x1176F0,0);//书生
写入D类(anogs+0x117820,0);//书生
写入D类(anogs+0x1178A8,0);//书生
写入D类(anogs+0x117AD8,0);//书生
写入D类(anogs+0x117AE0,0);//书生
